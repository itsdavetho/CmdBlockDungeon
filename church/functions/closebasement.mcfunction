...
function church:closewall
setblock 4875 21 -3530 lever[powered=true,face=wall,facing=west]

# command block
# execute if block 4872 19 -3522 cobblestone_stairs[facing=east] if block 4875 21 -3530 #minecraft:buttons[powered=true] run function church:closebasement