...
# make a sound effect 
execute unless block 4865 15 -3526 minecraft:iron_block unless entity @a[x=4862,y=15,z=-3531,dx=3,dy=3,dz=10] run playsound minecraft:entity.wither.break_block block @p 4865 15 -3526 1 0.1 1
