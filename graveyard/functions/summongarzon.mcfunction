...
# make some particles
unless entity @e[name="Sir Garzon"] run particle minecraft:smoke 4843 7 -3566 2 2 2 1 200
...
execute if entity @e[name="Sir Garzon"] run scoreboard players set @s garzonkilled 2
