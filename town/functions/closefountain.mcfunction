...
# command block
# execute unless entity @a[x=4842, y=3, z= -3544, dx=4,dy=5,dz=4, nbt= { Inventory: [ { tag: {garzonstrident: 1}  } ] } ] if entity @p[x=4842,y=3,z=-3544,dx=4,dy=5,dz=4] run function town:closefountain